...
bool Model::build_from_weights(){
    ...
    if (mWtsPath == "models/sample_cbr.weights") {
        network::build_cbr(*network, mPrecision, mWts);
    } else if (mWtsPath == "models/sample_resBlock.weights") {
        network::build_resBlock(*network, mPrecision, mWts);
    } else if (mWtsPath == "models/sample_convBNSiLU.weights") {
        network::build_convBNSiLU(*network, mPrecision, mWts);
    } else if (mWtsPath == "models/sample_c2f.weights") {
...
void Model::init_data(){
    if (mWtsPath == "models/sample_linear.weights") {
        ...
        mWtsPath == "models/sample_resBlock.weights" 
        || mWtsPath == "models/sample_convBNSiLU.weights" ) 
    {
        mInputSize = 25 * sizeof(float);
        mOutputSize = 75 * sizeof(float);
    } else if ( 
        mWtsPath == "models/sample_c2f.weights" )
    {
        mInputSize = 25 * sizeof(float);
