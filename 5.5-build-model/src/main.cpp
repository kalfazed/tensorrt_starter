...
int main(int argc, char const *argv[])
{
    ...
    */
    ...
    // Model model("models/sample_conv.weights");
    // Model model("models/sample_permute.weights");
    // Model model("models/sample_reshape.weights");         //目前观测到reshape会有精度下降
    // Model model("models/sample_batchNorm.weights");
    Model model("models/sample_cbr.weights");
