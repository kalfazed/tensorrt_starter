...
int main(int argc, char const *argv[])
{
    ...
    */
    ...
    // Model model("models/sample_cbr.weights", Model::precision::FP16);
    // Model model("models/sample_resBlock.weights", Model::precision::FP16);
    // Model model("models/sample_convBNSiLU.weights", Model::precision::FP32);
    Model model("models/sample_c2f.weights", Model::precision::FP32);
